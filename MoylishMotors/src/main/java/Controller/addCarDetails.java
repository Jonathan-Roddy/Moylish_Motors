 ...
 */
@WebServlet(name = "addCarDetails", urlPatterns = {"/addCarDetails"})
...
//        Character fullServiceHistory = FSH.charAt(1);
...
//            aCar.setFullServiceHistory(fullServiceHistory);
            aCar.setNote(note);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("DisplayAllCars");
